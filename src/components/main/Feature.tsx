const features = [
  {
    ...
    title: "معامله بیش از ۱۰۰۰ ارز دیجیتال",
    desc: "بیتفلر به شما کمک می‌کند تا به سرعت بیشتر و دقیقتر معامله را انجام دهید",
  },
  {
    icon: (
      <svg
    ...
    title: "کمترین کارمزد معاملاتی",
    desc: "مناسب‌ترین کارمزد معامله که به صورت پله‌ای و بر اساس حجم معامله شما تا ۰.۱٪ کاهش می‌یابد.",
  },
  {
    icon: (
      <svg
  ...
  },
  {
    ...
    title: "بیش از ۲۰۰ بازار معامله حرفه‌ای",
    desc: "بیش از ۲۰۰ بازار مختلف برای معامله‌گران حرفه‌ای با امکانات پیشرفته و ابزارهای متنوع.",
  },
  {
    icon: (
      <svg
  ...
  },
  {
    ...
    desc: "تیم پشتیبانی ما در هر لحظه آماده پاسخگویی به سوالات و حل مشکلات شماست.",
  },
];
